    ...
    return $.fn.ajaxChosen = function(options, callback) {
      ...
      return search = function(evt) {
        ...
        response = function(items, success) {
          var currentOpt, keydownEvent, latestVal, newOpt, newOptions, noResult, _fn, _fn1, _i, _j, _len, _len1;
          if (!field.is(':focus') && evt.type === 'keyup') {
            return;
          }
          newOptions = [];
          ...
          _fn = function(currentOpt) {
            ...
            presenceInNewOptions = (function() {
              ...
              _results = [];
              for (_j = 0, _len1 = newOptions.length; _j < _len1; _j++) {
          ...
          currentOptions = select.find('option');
          _fn1 = function(newOpt) {
            var currentOption, presenceInCurrentOptions, _fn2, _k, _len2;
            presenceInCurrentOptions = false;
            _fn2 = function(currentOption) {
              if ($(currentOption).attr('value') === newOpt.attr('value')) {
                return presenceInCurrentOptions = true;
              }
            };
            for (_k = 0, _len2 = currentOptions.length; _k < _len2; _k++) {
